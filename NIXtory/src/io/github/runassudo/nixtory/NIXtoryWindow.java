...
public class NIXtoryWindow {
	...
	private void initialize() {
		...
		btnInputAdd.setIcon(new ImageIcon(NIXtoryWindow.class.getResource("/io/github/runassudo/nixtory/assets/list-add.png")));
		pnInputAR2.add(btnInputAdd);
		
		JButton btnInputRemove = new JButton("");
		btnInputRemove.setIcon(new ImageIcon(NIXtoryWindow.class.getResource("/io/github/runassudo/nixtory/assets/list-remove.png")));
		...
		btnOutputAdd.setIcon(new ImageIcon(NIXtoryWindow.class.getResource("/io/github/runassudo/nixtory/assets/list-add.png")));
		pnOutputAR2.add(btnOutputAdd);
		
		JButton btnOutputRemove = new JButton("");
		btnOutputRemove.setIcon(new ImageIcon(NIXtoryWindow.class.getResource("/io/github/runassudo/nixtory/assets/list-remove.png")));
